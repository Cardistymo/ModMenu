...
public class ConfigOptionStorage {
	...
	public static <E extends Enum<E>> void cycleEnum(String key, Class<E> typeClass) {
		cycleEnum(key, typeClass, 1);
	}


	public static <E extends Enum<E>> void cycleEnum(String key, Class<E> typeClass, int amount) {
